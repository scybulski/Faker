...
class LicensePlate extends Base
{
     ...
     * @param  array|null $voivodeshipsRequested list of voivodeships license plate should be generated from
     * @param  array|null $countiesRequested     list of counties license plate should be generated from
     *
     * @return string
     */
    public static function licensePlate(
        bool $special = false,
        ?array $voivodeshipsRequested = null,
        ?array $countiesRequested = null
    ): string {
        $voivodeshipsAvailable = static::$voivodeships + ($special ? static::$specials : []);
        $voivodeshipCode = static::selectRandomArea($voivodeshipsAvailable, $voivodeshipsRequested);

        $countiesAvailable = static::$counties[$voivodeshipCode];
        $countySelected = self::selectRandomArea($countiesAvailable, $countiesRequested);
